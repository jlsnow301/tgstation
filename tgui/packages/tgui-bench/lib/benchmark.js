  ...
  function runInContext(context) {
    ...
    function filter(array, callback) {
      if (callback === 'successful') {
        ...
        var result = filter(array, 'successful').sort((a, b) => {
          a = a.stats;
          b = b.stats;
          return (
    ...
    function cloneSuite(options) {
      var result = new this.constructor(_.assign({}, this.options, options));
    ...
    function clone(options) {
      var result = new this.constructor(_.assign({}, this, options));
